...
void voxelgrid_gs(triangle vs_output input[3], inout TriangleStream< gs_output > outputStream)
{
	...
	//float texelSize = 1.f / 128.0f;
	float texelSize = 1.f / 64.0f;
	//float texelSize = 1.f / 2.0f;
	...
	//output[0].pos = float4(-30.0f, -30.0f, 0.5f, 1.0f);
	//output[1].pos = float4(30.0f, 30.0f, 0.5f, 1.0f);
	//output[2].pos = float4(30.0f, -30.0f, 0.5f, 1.0f);
	//output[0].pos = float4(10.0f, 40.0f, 2.5f, 1.0f);
	//output[1].pos = float4(30.0f, 40.0f, 2.5f, 1.0f);
	//output[2].pos = float4(40.0f, 10.0f, 2.5f, 1.0f);

	//output[0].pos = float4(-1.0f, 0.0f, 0.5f, 1.0f);
	//output[1].pos = float4(1.0f, 0.0f, 0.5f, 1.0f);
	//output[2].pos = float4(0.0f, 1.0f, 0.5f, 1.0f);
